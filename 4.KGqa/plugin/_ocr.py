...
# ======  绝对路径 ======
MODEL_BASE = r"F:\meet-Pok-mon\4.KGqa\plugin"
...
class OCRHandler2:
    ...
    def _lazy_load_ocr_engine(self):
        ...
        engine_path = os.path.join(MODEL_BASE, "SWHL", "RapidOCR", "PP-OCRv4")
    ...
    def pdf_ocr_pipeline(self, pdf_path: str) -> str:
        ...
        storage_dir = os.path.join('saves', 'data', 'pdf2txt', pdf_filename)
