...
doc1 = TextLoader(r"F:\bigmodel\meet-Pok-mon\4.KGqa\Pokemon-KGQA\RAG\data\精灵之沙暴天王.txt", encoding="gb18030").load()
...
llm = ChatOpenAI(
    model="deepseek-chat",  # 模型名称（需与后端匹配）
...
entities_vector_store = ChromaVectorStore(
    ...
    embedding_function=OpenAIEmbeddings(
        ...
        openai_api_key='sk-36oMlDApF5Nlg0v23014A4B69e864000944151Cd75D82076',
        chunk_size=32
    ),
)
